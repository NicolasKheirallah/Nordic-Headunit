...
template <> constexpr inline auto SystemSettings::qt_create_metaobjectdata<qt_meta_tag_ZN14SystemSettingsE_t>()
{
    ...
    QtMocHelpers::UintData qt_properties {
        ...
        // property 'bottomBarEnabled'
        QtMocHelpers::PropertyData<bool>(37, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 17),
        // property 'autoTime'
        QtMocHelpers::PropertyData<bool>(39, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 18),
        // property 'use24HourFormat'
        QtMocHelpers::PropertyData<bool>(41, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 19),
        // property 'timeZone'
...
void SystemSettings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 17: _t->bottomBarEnabledChanged((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 18: _t->autoTimeChanged((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (SystemSettings::*)(bool )>(_a, &SystemSettings::rainSensingWipersChanged, 16))
            return;
        if (QtMocHelpers::indexOfMethod<void (SystemSettings::*)(bool )>(_a, &SystemSettings::bottomBarEnabledChanged, 17))
            return;
        if (QtMocHelpers::indexOfMethod<void (SystemSettings::*)(bool )>(_a, &SystemSettings::autoTimeChanged, 18))
            return;
        if (QtMocHelpers::indexOfMethod<void (SystemSettings::*)(bool )>(_a, &SystemSettings::use24HourFormatChanged, 19))
            return;
        if (QtMocHelpers::indexOfMethod<void (SystemSettings::*)(const QString & )>(_a, &SystemSettings::timeZoneChanged, 20))
            return;
    ...
    if (_c == QMetaObject::ReadProperty) {
        ...
        case 18: *reinterpret_cast<bool*>(_v) = _t->bottomBarEnabled(); break;
        case 19: *reinterpret_cast<bool*>(_v) = _t->autoTime(); break;
        case 20: *reinterpret_cast<bool*>(_v) = _t->use24HourFormat(); break;
    ...
    if (_c == QMetaObject::WriteProperty) {
        ...
        case 18: _t->setBottomBarEnabled(*reinterpret_cast<bool*>(_v)); break;
...
// SIGNAL 17
void SystemSettings::bottomBarEnabledChanged(bool _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 17, nullptr, _t1);
}

// SIGNAL 18
void SystemSettings::autoTimeChanged(bool _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 18, nullptr, _t1);
}

// SIGNAL 19
void SystemSettings::use24HourFormatChanged(bool _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 19, nullptr, _t1);
}

// SIGNAL 20
void SystemSettings::timeZoneChanged(const QString & _t1)
{
